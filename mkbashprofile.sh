...
prefixes="$HOME/local:$HOME:$HOME/.cabal:$HOME/Library/Haskell:$HOME/.cargo:/usr/local:/opt/local:/opt/local/Library/Frameworks/Python.framework/Versions/$python:/usr"
path=/sbin:/usr/sbin
manpath=
infopath=
pkgconfigpath=
